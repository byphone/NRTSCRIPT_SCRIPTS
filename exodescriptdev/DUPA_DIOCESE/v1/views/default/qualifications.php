            ...
            switch ($model->scenario) {
                case 'APPARTENANCE_AUTRE_RELIGION' :
                    ...
                    <div class="row" style="background-color: #113060; color: #ffffff; height: 35px; margin-left: 0px; margin-right: 0px; margin-top: 5px;">
                        <div class="col-sm-12" style="text-align: center;"><h5><b>' . $NixxisQualification['Description'] . ' - RAISON DU REFUS</b></h5></div>
                    </div>
                    <div class = "row" >
                    <div class = "col-sm-6">';
                ...
                case 'NE_VEUT_PAS_DU_PA' :
                    ...
                    <div class = "row" >
                    <div class = "col-sm-6">';
                    echo $form->field($model, '_RAISON_REFUS')->dropDownList($model::getNeVeutPasDuPA(), ['prompt' => '--Select--'])->label('');
                    echo $form->field($model, 'RAISON_REFUS_AUTRE')->textarea(['rows' => 3, 'maxlength' => '255'])->label('Si "Autre", précisez (Attention, limite à 247 charactères)');
                    echo '<br/>
                    </div>
                    </div>';
                    break;
                case 'PROBLEME_DE_RECU_FISCAL' :
                    echo'
                    <div class="row" style="background-color: #113060; color: #ffffff; height: 35px; margin-left: 0px; margin-right: 0px; margin-top: 5px;">
                        <div class="col-sm-12" style="text-align: center;"><h5><b>RAISON DU REFUS</b></h5></div>
                    </div>
                    <div class = "row" >
                    <div class = "col-sm-6">';
                    echo $form->field($model, '_RAISON_REFUS')->dropDownList($model::getProblemeDeRecuFiscal(), ['prompt' => '--Select--'])->label('');
                    echo $form->field($model, 'RAISON_REFUS_AUTRE')->textarea(['rows' => 3, 'maxlength' => '255'])->label('Si "Autre", précisez (Attention, limite à 247 charactères)');
                    echo '<br/>
                    </div>
                    </div>';
