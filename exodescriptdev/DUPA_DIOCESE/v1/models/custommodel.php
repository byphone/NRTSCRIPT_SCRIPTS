...
class custommodel extends \app\models\Nixxis\Data {
    ...
    public function beforeValidate() {
        ...
        if (($this->scenario == 'NE_VEUT_PAS_DU_PA' || $this->scenario == 'PROBLEME_DE_RECU_FISCAL') && $this->_RAISON_REFUS == 'AUTRE') {
            $this->_RAISON_REFUS = $this->_RAISON_REFUS . " : " . $this->RAISON_REFUS_AUTRE;
        }
    ...
    public function rules() {
        ...
        $rules = [
            [['INTERLOCUTEUR', 'N_DATEPA_DAY', 'N_DATEPA_MONTH', 'N_DATEPA_YEAR', 'N_DATERETOUR_DAY', 'N_DATERETOUR_MONTH', 'N_DATERETOUR_YEAR', 'RAISON_REFUS_AUTRE'], 'safe'],
            ...
            [['_RAISON_REFUS'], 'required', 'on' => 'NE_VEUT_PAS_DU_PA', 'message' => 'Ce champs ne peut être vide'],
            [['_RAISON_REFUS'], 'required', 'on' => 'PROBLEME_DE_RECU_FISCAL', 'message' => 'Ce champs ne peut être vide'],
    ...
    public static function getNeVeutPasDuPA() {
        return [
            'PEUR DE L’ENGAGEMENT' => 'Peur de l\'engagement',
            'COMPLEXITE' => 'Compléxité',
            'DONS IRREGULIERS' => 'Dons irréguliers',
            'DON DIRECTEMENT AU PRETRE' => 'Don directement au prêtre',
            'DON MODESTE' => 'Don modeste',
            'PREFERE RECEVOIR SON COURRIER CHAQUE ANNEE' => 'Préfére recevoir son courrier chaque année',
            'DON EN PA AUTRE(S) ORGANISME(S)' => 'Don en PA autre(s) organisme(s)',
            'AUTRE' => 'Autre',
        ];
    }

    public static function getProblemeDeRecuFiscal() {
        return [
            'RECU TROP TARD' => 'Reçu trop tard',
            'JAMAIS RECU' => 'Jamais reçu',
            'RECU AVEC ERREUR' => 'Reçu avec erreur',
            'AUTRE' => 'Autre',
        ];
    }
