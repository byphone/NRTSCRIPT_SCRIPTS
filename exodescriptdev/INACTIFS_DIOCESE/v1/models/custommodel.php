...
namespace app\scripts\INACTIFS_DIOCESE\v1\models;
...
class custommodel extends \app\models\Nixxis\Data {
    ...
    public function beforeValidate() {
        ...
        if ($this->_RAISON_ARRET == 'AUTRE') {
            $this->_RAISON_ARRET = $this->_RAISON_ARRET . " : " . $this->RAISON_ARRET;
        }
    ...
    public function rules() {
        ...
        $rules = [
            [['INTERLOCUTEUR', 'RAISON_ARRET', 'N_DATEPA_DAY', 'N_DATEPA_MONTH', 'N_DATEPA_YEAR', 'N_DATERETOUR_DAY', 'N_DATERETOUR_MONTH', 'N_DATERETOUR_YEAR'], 'safe'],
    ...
    public static function getDecuParEglise() {
        return [
            ...
            'REFUS DE COMMUNION/BAPTEME/MARIAGE' => 'Refus de communion/baptême/mariage',
    ...
    public static function getRaisonArret() {
        return [
            '' => '',
            'PROBLEME PERSONNEL (SANTE/DECES)' => 'Problème personnel (Santé/Décès)',
            'PAS DE BUDGET' => 'Pas de budget',
            'A TOUJOURS DONNE' => 'A toujours donné',
            'DON IRREGULIER' => 'Don irrégulier',
            'DON EN PAROISSE' => 'Don en paroisse',
            'PROBLEME RECU FISCAL' => 'Problème recu fiscal',
            'AUTRE' => 'Autre à renseigner',
        ];
    }
