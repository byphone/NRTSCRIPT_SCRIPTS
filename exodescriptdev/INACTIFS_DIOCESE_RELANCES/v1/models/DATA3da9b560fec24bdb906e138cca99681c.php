...
*
    ...
    * @property integer $_NE_PAS_RELANER
*/
...
$rules = [
            ...
            [['MODIF_EMAIL', 'MODIF_TEL', '_CONNAIT_LE_DENIER', 'MODIF_ADRESSE', '_DEPOT_PAROISSE', '_NE_PAS_RELANER'], 'integer']
        ];
...
return [
    ...
    '_NE_PAS_RELANER' => 'Ne  Pas  Relaner',
];
}
}
