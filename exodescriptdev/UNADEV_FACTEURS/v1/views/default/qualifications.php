        ...
        <div class="col-sm-10">
            ...
            switch ($model->scenario) {
                ...
                case 'ENVOYE':
                    ...
                    echo $form->field($model, '_PROMESSEENVOYEE')->dropDownList(\app\scripts\UNADEV_FACTEURS\v1\models\DATA9cd8682fa7a34c50b37332e82d7b807a::GetFormulairePromesseEnvoyee(), [
                        'prompt' => 'Select type',
                        'onchange' => '
                                        $.post( "index.php?r=' . $Module::getRoute() . '/default/list-site&id=' . '"+$(this).val(), function( data ) {
                                            $( "select#data9cd8682fa7a34c50b37332e82d7b807a-n_periodicite" ).html( data );
                                        });'
                    ])->label('Promesse');

                    echo $form->field($model, 'N_MONTANT')->textInput()->label('Montant de la promesse');
                    echo SelectWidget::widget(['label' => "Périodicité", 'model' => $model, 'field' => 'N_PERIODICITE', 'form' => $form, 'data' => \app\scripts\UNADEV_FACTEURS\v1\models\DATA9cd8682fa7a34c50b37332e82d7b807a::getPeriodicite($model->_PROMESSEENVOYEE)]);
                    echo '</div>';
                    //echo $model::GetMonthProchainPA();
                    echo '</div>';
                    echo '</div> 
