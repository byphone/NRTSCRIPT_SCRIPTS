...
namespace app\scripts\CONQUETE_RELANCES\v1\controllers;
...
class DefaultController extends \app\controllers\ScriptController {
    ...
    private function AffectScenario($NixxisQualificationId, &$model, &$model_qualifications) {
        ...
        switch ($NixxisQualificationId) {
            case '3fda90b0d6dc4913a033a3d98570e127': //REFUS AUTRE A RENSEIGNER
                $model->scenario = 'REFUS_AUTRE';
                $model_qualifications->nextstep = 'qualifications';
                break;
            case '03fd6fdae9d949858975cbf8b42cffcb': //PAS RECU R1
                $model->scenario = 'PROMESSE';
                $model_qualifications->nextstep = 'qualifications';
                break;
            case '0629c34c7f6e4991957072b142306161': //PAS RECU R2
                $model->scenario = 'PROMESSE';
                $model_qualifications->nextstep = 'qualifications';
                break;
    ...
    public function actionListPeriodicites($id) {
        /* @var $model \app\scripts\CONQUETE_RELANCES\v1\models\DATA2b02e8a0d7fb4a79a37bdaa12396c047 */
        /* @var $model_qualifications \app\models\NixxisQualifications */
        $data = \app\scripts\CONQUETE_RELANCES\v1\models\DATA2b02e8a0d7fb4a79a37bdaa12396c047::getPeriodicite($id);
