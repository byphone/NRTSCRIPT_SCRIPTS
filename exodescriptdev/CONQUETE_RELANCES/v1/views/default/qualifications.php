...
//                    echo SelectWidget::widget(['label' => "Promesse", 'model' => $model, 'field' => 'NV_PROMESSE', 'form' => $form, 'data' => $model::getPromesses()]);
                    ...
                    echo $form->field($model, 'NV_PROMESSE')->dropDownList(\app\scripts\CONQUETE_RELANCES\v1\models\DATA2b02e8a0d7fb4a79a37bdaa12396c047::getPromesses(), [
                        'prompt' => 'Select type',
                        'onchange' => '
                                                    $.post( "index.php?r=' . $Module::getRoute() . '/default/list-periodicites&id=' . '"+$(this).val(), function( data ) {
                                                        $( "select#data2b02e8a0d7fb4a79a37bdaa12396c047-nv_periodicite" ).html( data );
                                                    });'
                    ])->label('Promesse');

                    echo TextBoxWidget::widget(['label' => "Montant", 'model' => $model, 'field' => 'NV_MONTANT', 'form' => $form, 'ro' => false]);
                    echo SelectWidget::widget(['label' => "Périodicité", 'model' => $model, 'field' => 'NV_PERIODICITE', 'form' => $form, 'data' => \app\scripts\CONQUETE_RELANCES\v1\models\DATA2b02e8a0d7fb4a79a37bdaa12396c047::getPeriodicite($model->NV_PROMESSE)]);
