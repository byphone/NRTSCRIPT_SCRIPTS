...
//                    echo SelectWidget::widget(['label' => "Promesse", 'model' => $model, 'field' => 'NV_PROMESSE', 'form' => $form, 'data' => $model::getPromesses()]);
                    ...
                    echo $form->field($model, 'NV_PROMESSE')->dropDownList(\app\scripts\CONSOLIDATION_RELANCES\v1\models\DATAA7706e66190241b59f40f6962948ebab::getPromesses(), [
                        'prompt' => 'Select type',
                        'onchange' => '
                                                    $.post( "index.php?r=' . $Module::getRoute() . '/default/list-periodicites&id=' . '"+$(this).val(), function( data ) {
                                                        $( "select#dataa7706e66190241b59f40f6962948ebab-nv_periodicite" ).html( data );
                                                    });'
                    ])->label('Promesse');

                    echo TextBoxWidget::widget(['label' => "Montant", 'model' => $model, 'field' => 'NV_MONTANT', 'form' => $form, 'ro' => false]);
                    echo SelectWidget::widget(['label' => "Périodicité", 'model' => $model, 'field' => 'NV_PERIODICITE', 'form' => $form, 'data' => \app\scripts\CONSOLIDATION_RELANCES\v1\models\DATAA7706e66190241b59f40f6962948ebab::getPeriodicite($model->NV_PROMESSE)]);
